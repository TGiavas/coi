...
<div class="wrapper-table">
    ...
    echo "<div class='page-header clearfix'>
        <h2 class='pull-left'>Firm Projects</h2>
    </div>";
    ...
    //Table of the firm's stakeholders

    echo "<div class='page-header clearfix'>
        <h2 class='pull-left'>Stakeholders</h2>
    </div>";

    $sql = "SELECT * FROM firm_stakeholder WHERE stakeholder_firm = 'test'";
    if ($result = mysqli_query($conn, $sql)) {
        if (mysqli_num_rows($result) > 0) {

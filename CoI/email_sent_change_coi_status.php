...
<script type="text/javascript">
  var count = 10; // Timer
  var redirect = "conflicts.php"; // Target URL
...
<div id="master-wrap">
  <div id="logo-box">
    ...
    <div class="notice animated fadeInUp">
      <p class="lead">An email has been sent to the public servant notifying him of the decision for his conflict of interest!</p>
      <a class="btn animation" href="conflicts.php">&larr; Back</a>
    </div>
